...
<div class="wrapper">
	<div class="bio-box">
		...
		<p class="bio">
			...
			interested in cryptocurrency, currently co-founding <a href="https://twitter.com/ILL_Blockchain" target="_blank">Illini Blockchain</a>, building on Solana. I
			like to write, and occasionally I'll brave my small corner of the web and publish something.
		</p>
		<p class="links">
